...
ALTER TABLE SALES ADD CONSTRAINT id_not_null CHECK(SALE_ID IS NOT NULL);

-- ALTER TABLE SALES DROP CONSTRAINT id_not_null;
-- ALTER TABLE SALES modify SALE_AMOUNT NUMBER(2);
-- ALTER TABLE SALES DROP COLUMN SALE_ID;
-- ALTER TABLE SALES RENAME COLUMN sale_id to SID;
